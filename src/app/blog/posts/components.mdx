...
/>`,
  ...
  >
    <Button
      href="https://once-ui.com/docs/feedback"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
/>`,
  ...
  >
    <Button
      href="https://once-ui.com/docs/table"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
        ...
        items={[
          {
            ...
            content: (
              <Text variant="body-default-s" onBackground="neutral-weak">
                This is the content for section 1. You can include any
                components here.
              </Text>
            ),
          },
          {
            ...
            content: (
              <Text variant="body-default-s" onBackground="neutral-weak">
                This is the content for section 2. Accordions are great for FAQs
                and other expandable content.
              </Text>
            ),
          },
          {
            ...
            content: (
              <Text variant="body-default-s" onBackground="neutral-weak">
                This is the content for section 3. They help save space by
                hiding content until needed.
              </Text>
            ),
          },
        ]}
...
/>`,
  ...
  >
    <Button
      href="https://once-ui.com/docs/accordion"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Column fillWidth gap="-1" marginBottom="16" marginTop="8">
  ...
  >
    <Button
      href="https://once-ui.com/docs/button"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Column fillWidth gap="-1" marginBottom="16" marginTop="8">
  <CodeBlock
        ...
        >
          ...
          <Column fillWidth padding="12" gap="8" horizontal="start">
            ...
            <Text
              ...
              align="left"
            >
              This is a description of the card. It can contain multiple lines
              of text.
            </Text>
          </Column>
        </Card>
    ...
    padding="4"
  >
    <Media src="/images/projects/project-01/1.png" aspectRatio="16/9" radius="l" sizes="400px" />
    <Column fillWidth padding="12" gap="8" horizontal="start">
  ...
  >
    <Button
      href="https://once-ui.com/docs/card"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Icon name="search" size="m" />`,
  ...
  >
    <Button
      href="https://once-ui.com/docs/icon"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Column fillWidth gap="-1" marginBottom="16" marginTop="8">
  <CodeBlock
    ...
    topRadius="l"
    preview={
      <Row fillWidth s={{ direction: "column" }} gap="16">
  ...
  >
    <Button
      href="https://once-ui.com/docs/flex"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Column fillWidth gap="-1" marginBottom="16" marginTop="8">
  ...
  >
    <Button
      href="https://once-ui.com/docs/grid"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
/>`,
  ...
  >
    <Button
      href="https://once-ui.com/docs/Media"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
...
<Column fillWidth gap="-1" marginBottom="16" marginTop="8">
  <CodeBlock
    ...
    codes={[
      {
        code: `<SmartLink href=" " suffixIcon="chevronRight">Link with icon</SmartLink>`,
        language: "tsx",
        label: "SmartLink",
      },
    ]}
  ...
  >
    <Button
      href="https://once-ui.com/docs/smart-link"
      weight="default"
      label="View on Once UI"
      size="s"
      variant="tertiary"
